...
dim(geno)
# geno[1:10, 1:10]
#'-9' was the missing data, coding are: 0, 1, 2
```
...
```{r, eval=FALSE}
#check missing values in pheno data
...
# ratio of variance components 
fit2$Ve / fit2$Vu
#compare manually calculation results with model fitting calculation
